...
import { createZoomCheckoutSession } from '@/lib/stripe';
...
const ZoomBooking: React.FC = () => {
  ...
  const zoomPrice = 10;
  const total = quantity * zoomPrice;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await createZoomCheckoutSession({
  ...
  return (
    <>
      <SEO
        title="Join Online via Zoom"
        description="Watch the Build Wealth Through Property seminar live from anywhere. £10 per pass. Saturday 14 March 2026, 2:00 PM – 5:00 PM. Expert panel, live Q&A."
        canonical="/zoom"
        jsonLdEvent
      />
                ...
                <div className="sticky top-24">
                  <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 shadow-2xl">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold text-white">Join via Zoom</h2>
                        <p className="text-slate-300 text-sm">Property Investment Seminar — Online</p>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center gap-3 text-white">
                        ...
                        <div className="flex items-center gap-3 text-white">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">2:00 PM – 5:00 PM (UK)</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3 text-white">
                          <div className="w-10 h-10 bg-amber-500/20 rounded-lg flex items-center justify-center">
                          ...
                          <div>
                            <p className="text-slate-400 text-xs">Join from</p>
                            <p className="font-semibold">Anywhere — laptop, tablet, or phone</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3 text-white">
                          <div className="w-10 h-10 bg-amber-500/20 rounded-lg flex items-center justify-center">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">£10 per pass</p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="pt-6 border-t border-slate-700">
                      <div className="flex items-start gap-3 text-slate-300 text-sm">
                        ...
                        <p>Full 3-hour live seminar stream</p>
                      </div>
                      <div className="flex items-start gap-3 text-slate-300 text-sm mt-3">
                        <CheckCircle2 className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" />
                        <p>Expert panel & live Q&A</p>
                      </div>
                      <div className="flex items-start gap-3 text-slate-300 text-sm mt-3">
                        <CheckCircle2 className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" />
                        <p>Zoom link sent to your email</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 flex flex-col gap-2">
                    <Link
                      to="/booking"
                      className="flex items-center justify-center gap-2 w-full py-3 rounded-xl border-2 border-slate-200 text-slate-600 hover:border-amber-400 hover:text-amber-600 font-medium transition-colors"
                    >
                      <Home className="w-4 h-4" />
                      Prefer In-Person? Book Belfast
                    </Link>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
                  <div className="mb-8">
                    ...
                    <p className="text-slate-600">
                      Secure your online access to the seminar. Same content, same experts — from your sofa.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="bg-gradient-to-r from-amber-50 to-amber-100 rounded-xl p-6 border border-amber-200">
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex-1 text-center">
                          ...
                          <div className="text-sm text-slate-600">@ £{zoomPrice} each</div>
                        </div>
                        <button
                          type="button"
                    ...
                    <div className="space-y-5">
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            disabled={isProcessing}
                            className="w-full pl-12 pr-4 py-3.5 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all disabled:bg-slate-50"
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1.5">Zoom link and confirmation sent here</p>
                      </div>
                    ...
                    <div className="bg-slate-50 rounded-xl p-6 border-2 border-slate-200">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-slate-600">Zoom Pass{quantity > 1 ? 'es' : ''} ({quantity}x)</span>
                    ...
                    <p className="text-xs text-slate-500 text-center">
                      By proceeding, you agree to our terms of service. Passes are non-refundable.
                    </p>
                  </form>
                </div>
              </div>
